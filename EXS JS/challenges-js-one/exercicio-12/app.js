...
for(let i = 0; i < best2019Movies.length; i++){
   console.log(`${best2019Movies[i].title} dirigido por ${best2019Movies[i].directedBy}`)
...
const youtubeUser = {
  ...
  exib: () =>{
    console.log(`Videos recentes de ${youtubeUser.name}: ${youtubeUser.videos.recentVideos[0].title}${youtubeUser.videos.recentVideos[1].title} ${youtubeUser.videos.recentVideos[2].title}`)
  }
}
youtubeUser.exib()
...
console.log(parseInt(fourthNumber))
