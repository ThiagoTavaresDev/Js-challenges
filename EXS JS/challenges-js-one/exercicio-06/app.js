...
age = 0
if(age <= 7 || age >= 65){
    const fator = 'A entrada pra ti é gratis'
    console.log(fator)
} else{
    const fator = 'A entrada é R$ 30,00'
    console.log(fator)
}
...
console.log(booleans,numeros,strings)
...
console.log(`Numeros ímpares: ${arrayOdd.slice(0 ,1)} ${arrayOdd.slice(1 ,2)} e ${arrayOdd.slice(2 ,3)}`)
console.log(`Numeros pares: ${arrayEven.slice(0 ,1)} ${arrayEven.slice(1 ,2)} e ${arrayEven.slice(2 ,3)}`)